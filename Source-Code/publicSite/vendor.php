...
<body class="animsition">
    ...
    <div class='col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {$row['category_name']}'>

    <div class='block2'>
        <div class='block2-pic hov-img0'>
            <img src='../admin/{$row['product_image']}' alt='IMG-PRODUCT' style='height:17rem;width:20rem'>
